...
class Login extends Component {
    ...
    handleValidSubmit = async (event, values) => {
        const res = await fetchJSON(BASE_URL + '/user/merchant/login', {
            method: 'POST',
        ...
        if (res.success) {
            ...
            this.props.loginUser('wrong', 'wrong', this.props.history);
        }
    }
                                            ...
                                            <Col md={6} className="p-5 position-relative">
                                                ...
                                                <div className="mx-auto mb-5">
                                                    <a href="/">
                                                        ...
                                                        <h3 className="d-inline align-middle ml-1 text-logo">Lazydoor</h3>
                                                    </a>
                                                </div>
                                                ...
                                                <AvForm onValidSubmit={this.handleValidSubmit} className="authentication-form">
                                                    <AvGroup className="">
                                                        ...
                                                        <InputGroup>
                                                            ...
                                                            <AvInput type="text" name="username" id="username" placeholder="name@company.com" value={this.state.username} required />
                                                        </InputGroup>
